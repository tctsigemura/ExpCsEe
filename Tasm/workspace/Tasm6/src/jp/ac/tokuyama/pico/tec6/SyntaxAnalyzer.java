...
abstract class SyntaxAnalyzer {
  ...
  static final SyntaxAnalyzer M6 = new M6(); // JMP,JZ,JC,JM,CAll
  static final SyntaxAnalyzer P1 = new P1(); // EQU,DS,ORG,DC

  private static void strToByte(String s, Vector v) {
    int len = s.length();
  ...
  private static void dc(Lexer lexer, SymTbl symTbl, Vector v, boolean parseOnly)
    throws AsmException {
